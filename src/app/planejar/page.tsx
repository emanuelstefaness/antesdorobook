...
export const metadata = pageMetadata(
  "planejar",
  "Doze planos de aula prontos, filtráveis por ano, tempo disponível, recursos e conteúdo — com roteiro completo e versão para imprimir.",
);
    ...
    <>
      <PageHeader stageId="planejar">
        ...
        <p className="mt-4 max-w-[56ch] font-sans text-[15px] leading-relaxed text-navy/70">
          Doze planos prontos, cada um com preparação, roteiro completo, avaliação e versão para
